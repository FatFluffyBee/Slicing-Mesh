...
public static class CuttingMeshTest
{
    public static bool CutMesh(Plane plane, Mesh mesh, GameObject originalMesh)
    {
        ...
        Material mat = originalMesh.GetComponent<MeshRenderer>().material;
   ...
   //// MeshRenderer doit update les materials utilis�s
   ///Mauvaise reconnaissance de comparaison du material de is Cuttabke et du mashRenderer 
}
